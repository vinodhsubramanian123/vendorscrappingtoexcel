...
| [.agents/skills/boq-eval-skill/SKILL.md](file:///Users/macbookaira1466/Downloads/booktoSkill/.agents/skills/boq-eval-skill/SKILL.md) | Pre-Flight BOQ Evaluation Skill | Standardized 4-phase workflow for parsing customer BOQs, pre-cleaning data, calculating consolidated quantities, running TDP/fan/riser/power physical math, querying Gemini Notebook, and outputting 5-tier resolution reports. | Antigravity AI Agent & Engineers |
...
| [docs/GEN12_CATALOG_RULES_AND_CONSISTENCY_CHARTER.md](file:///Users/macbookaira1466/Downloads/booktoSkill/docs/GEN12_CATALOG_RULES_AND_CONSISTENCY_CHARTER.md) | Gen12 Rules & Consistency Charter | Master configuration rules, 5-Tier Strategic Resolution Hierarchy, physical math, chassis base prices ($5,584.00), support pricing, and reusable System Prompt Template. | Antigravity AI Agent & Auditors |
